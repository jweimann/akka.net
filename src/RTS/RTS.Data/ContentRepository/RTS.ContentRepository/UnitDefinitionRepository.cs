...
namespace RTS.ContentRepository
{
    public class UnitDefinitionRepository : IRepository<UnitDefinition, UnitType>
    {
        ...
        public UnitDefinitionRepository()
        {
            ...
            _unitDefinitions.Add(UnitType.BaseStation, new UnitDefinition() { BuildTime = 2, Name = "Base Station", Cost = 1, StartingHP = 1000, UnitType = UnitType.BaseStation, SpawnLocationRequired = true, ResourceAmount = 10, ResourceInterval = 3.0, CanBuild = new List<UnitType>() { UnitType.Engineer, UnitType.Truck, UnitType.StugIII } });
